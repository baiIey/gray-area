...
Including the block below in `index.html` allowed us to extend the p5 library.
~~~~
...
Pinning my IDE and browser with macOS' [Split View](https://support.apple.com/en-us/HT204948) makes for a decent IDE.
